/*
Task-2 Utilise constructors and destructors with message when destroyed for Car Class
*/

//creating a Car class with constructor and destructor
#include<iostream>
#include<iomanip>
...
public:
    ...
    ~Car()
    {
        cout<<"Car Constructor Destroyed";
    }
};
